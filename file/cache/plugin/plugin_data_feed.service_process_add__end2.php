...
<?php $aContent = 'if (Phpfox::isModule(\'socialpublishers\') && $sType != \'pages_comment\' && $sType != \'event\' && $aInsert[\'type_id\'] == "user_status" && isset($aInsert[\'parent_feed_id\']) && $aInsert[\'parent_feed_id\'] > 0)
{    
