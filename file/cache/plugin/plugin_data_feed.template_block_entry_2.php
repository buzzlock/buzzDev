...
<?php $aContent = 'if(PHPFOX::getLib("request")->get("req1") == "advancedmarketplace") { ?>
	...
	<?php } ?>
<?php }  if (isset($this->_aVars[\'aFeed\']) && isset($this->_aVars[\'aFeed\'][\'comment_type_id\']) && $this->_aVars[\'aFeed\'][\'comment_type_id\'] == \'photo\' && isset($this->_aVars[\'aFeed\'][\'feed_display\']) && $this->_aVars[\'aFeed\'][\'feed_display\'] == \'view\')
{
