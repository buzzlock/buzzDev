...
<?php $aContent = ' if (isset($this->_aUser[\'user_id\']) && $this->_aUser[\'user_id\'] > 0 && Phpfox::getParam(\'subscribe.subscribe_is_required_on_sign_up\') && $this->_aUser[\'user_group_id\'] == \'2\' && $this->_aUser[\'subscribe_id\'] > 0)
{
	$bSetDirect = true;	
