...
<?php $aContent = '$aSettings = $this->template()->getVar(\'aSettings\');
...
if (isset($aSettings[$product_id])) {
    ...
    <script type="text/javascript">
        ...
        if(color == "rgb(255, 255, 255)")
            $(document.getElementsByName(\'val[value_actual][<?php echo $param_id; ?>]\')).last().parent().parent().removeClass(\'table2\').addClass(\'table1\');
        else
            $(document.getElementsByName(\'val[value_actual][<?php echo $param_id; ?>]\')).last().parent().parent().removeClass(\'table1\').addClass(\'table2\');
    </script>
