...
<?php $aContent = array (
  ...
  'advanced_photos' => 'Advanced Photos',
  'album' => 'Album',
  'albums' => 'Albums',
  ...
  'box_rain' => 'Box Rain',
  'box_rain_grow' => 'Box Rain Grow',
  'box_rain_grow_reverse' => 'Box Rain Grow Reverse',
  'box_rain_reverse' => 'Box Rain Reverse',
  ...
  'edit_album_order' => 'Edit Albums Order',
...
<a href="{link}">{link}</a>',
  ...
  'full_name_has_already_been_tagged_in_this_album' => '{full_name} has already been tagged in this album.',
  ...
  'full_name_tagged_you_in_an_album' => '{full_name} tagged you in an album.',
  'full_name_tagged_you_in_a_photo' => '{full_name} tagged you in a photo.',
  'full_name_tagged_you_on_gender_album' => '{full_name} tagged you on {gender} album "<a href="{link}">{title}</a>".',
  'full_name_tagged_you_on_gender_photo' => '{full_name} tagged you on {gender} photo "<a href="{link}">{title}</a>".',
  'full_name_tagged_you_on_user_album' => '{full_name} tagged you on {other_full_name}&#039;s album "<a href="{link}">{title}</a>
...
<a href="{link}">{link}</a>',
  ...
  'in_photos_of_this_album' => 'In Photos of This Album',
  ...
  'menu_advancedphoto_advanced_photo_fad58de7366495db4650cfefac2fcd61' => 'Advanced Photo',
  'menu_advancedphoto_upload_a_new_image_51bc6e65d9270f31427c50924dad76f6' => 'Upload a New Image',
  'menu_photos' => 'Photos',
  ...
  'module_photo' => 'Photos',
  'most_commented_photos' => 'Most Commented Photos',
  'most_discussed' => 'Most Discussed',
  'most_liked' => 'Most Liked',
  'most_liked_photos' => 'Most Liked Photos',
  'most_shared_photos' => 'Most Shared Photos',
  'most_talked_about' => 'Most Talked About',
  'most_viewed' => 'Most Viewed',
  'most_viewed_photos' => 'Most Viewed Photos',
  'move_to' => 'Move to',
  'my_albums' => 'My Albums',
  'my_photos' => 'My Photos',
  'name' => 'Name',
  'name_by_full_name' => '{name} by {full_name}',
  'name_can_not_be_blank_please_fill' => 'Name can not be blank. Please fill the name of this album.',
  'newest_albums' => 'Newest Albums',
  ...
  'not_allowed_to_tag_this_album' => 'Not allowed to tag this album.',
  ...
  'no_more_tags_for_this_album_can_be_added' => 'No more tags for this album can be added.',
  ...
  'provide_an_album_tag' => 'Provide an album tag.',
  ...
  'search_album_results' => 'Search Album Results',
...
This setting tells how many categories to show. Set to 0 if you dont want to show categories in the title of the page when viewing a photo.</info>',
  'setting_member_on_top_member_block' => '<title>Number of Member on Top Member Block</title><info>Number of Member on Top Member Block</info>',
  'setting_number_of_albums_in_other_album_block' => '<title>Number of Albums in Other Albums Block</title><info>Number of Albums in Other Albums Block</info>',
  'setting_number_of_photos_displayed_on_blocks_newrandom_on_homepage' => '<title>Number of photos displayed on Newest/ Random blocks</title><info>Number of photos displayed on Newest/ Random blocks</info>',
  'setting_number_of_photos_displayed_on_top_blocks_on_homepage' => '<title>Number of photos displayed on Most Viewed/ Most Commented/ Most Liked/ This Month/ This Week/ Today blocks</title><info>Number of photos displayed on Most Viewed/ Most Commented/ Most Liked/ This Month/ This Week/ Today blocks on homepage</info>',
  'setting_number_of_photos_display_on_featured_slide' => '<title>Number of Photos on Featured Photos Slideshow</title><info>Number of Photos on Featured Photos Slideshow.</info>',
  'setting_number_of_photos_each_click' => '<title>Number of Photos Each Year on My Photos</title><info>Number of Photos displayed when clicking on a year or view more link in My Photos page.</info>',
  'setting_number_of_user_on_in_photos_of_this_album_block' => '<title>Number of Users Displayed on "In Photos of This Album" Block</title><info>Number of Users Displayed on "In Photos of This Album" Block.</info>',
...
Under that line you will find 2 lines that have been commented out. Simply uncomment those 2 lines by removing the hash "#" symbol.
  ...
  'setting_total_tags_on_albums' => '<title>Total Tags on Photos</title><info>Define how many tags a photo can have.</info>',
  ...
  'slice_down' => 'Slice Down',
  'slice_down_left' => 'Slice Down Left',
  'slice_down_right' => 'Slice Down Right',
  'slice_up' => 'Slice Up',
  ...
  'start_typing_a_friend_s_name' => 'Start typing a friend&#039;s name',
  'statistic' => 'Statistic',
  'stat_title_3' => 'Photos',
  ...
  'tagged_a_href_row_link_full_name_a_on_a_href_album_user_name_album_full_name_a_a_href_link_album_a' => 'tagged <a href="{row_link}">{full_name}</a> on <a href="{album_user_name}">{album_full_name}&#039;s</a> <a href="{link}">album</a>.',
  'tagged_a_href_row_link_full_name_a_on_a_href_photo_user_name_photo_full_name_a_a_href_link_photo_a' => 'tagged <a href="{row_link}">{full_name}</a> on <a href="{photo_user_name}">{photo_full_name}&#039;s</a> <a href="{link}">photo</a>.',
  'tagged_a_href_row_link_full_name_a_on_gender_a_href_link_album_a' => 'tagged <a href="{row_link}">{full_name}</a> on {gender} <a href="{link}">album</a>.',
  'tagged_gender_on_a_href_link_album_full_name_s_album' => 'tagged {gender} on <a href="{link}">{album_full_name}',
  'tagged_gender_on_a_href_link_photo_full_name_s_photo' => 'tagged {gender} on <a href="{link}">{photo_full_name}</a>&#039;s photo.',
  'tagging_successfully' => 'Tagging Successfully',
  'tags' => 'Tags',
  ...
  'this_album_is_already_tagged' => 'This album is already tagged.',
  'this_month_photos' => 'This Month Photos',
  ...
  'this_week_photos' => 'This Week Photos',
  'time' => 'Time',
  'time_separator' => 'at',
  ...
  'ull_name_tagged_you_on_gender_album' => '{full_name} tagged you on {gender} album "<a href="{link}">{title}</a>".',
  'unable_to_delete_this_tag' => 'Unable to delete this tag.',
  'unable_to_find_album' => 'Unable to find album.',
  'unable_to_find_photo' => 'Unable to find photo.',
  'unable_to_find_the_album' => 'Unable to find the album.',
...
<a href="{link}">{link}</a>',
  ...
  'user_name_tagged_you_in_span_class_drop_data_user_full_name_s_span_album_title' => '{user_name} tagged you in <span class="drop_data_user">{full_name}&#039;s</span> album "{title}"',
...
If set to false, the admin will have to approve each new purchased sponsored photo space before it is shown in the site.',
  ...
  'user_setting_can_feature_album' => 'Can feature an album?',
  ...
  'user_setting_can_tag_other_albums' => 'Can tag other albums?',
  'user_setting_can_tag_other_photos' => 'Can tag photos added by other users?',
  'user_setting_can_tag_own_album' => 'Can tag own album?',
...
Note: Setting it to "0" (without quotes) is default and users will not have to wait.',
  'user_setting_how_many_tags_on_other_album' => 'How many times can this user tag albums added by other users?',
  'user_setting_how_many_tags_on_other_photo' => 'How many times can this user tag photos added by other users?',
  'user_setting_how_many_tags_on_own_album' => 'How many times can a user tag their own album?',
...
This works in a CPM basis.',
  'user_setting_points_advancedphoto' => 'Points received when uploading a new image.',
...
[/code]',
  ...
  'user_setting_total_photo_display_profile' => 'Define how many photos to display when a user views another user\'s album.',
  'use_mass_uploader' => 'Use mass uploader',
  'use_simple_uploader' => 'Use simple uploader',
  'views' => 'Views',
  'view_album_full_sreen' => 'Full Screen',
...
<a href="{sLink}">{sLink}</a>',
  ...
  'you_tagged_yourself_in_your_album_title' => 'You tagged yourself in your album "{title}"',
