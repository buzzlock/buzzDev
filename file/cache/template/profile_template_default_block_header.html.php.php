 ...
 * @version 		$Id: header.html.php 6990 2013-12-12 17:40:03Z Fern $
 */
...
?>
	<div<?php if (Phpfox ::getService('profile')->timeline()): ?> class="profile_timeline_header_holder"<?php endif; ?>>
		<div class="profile_header<?php if (Phpfox ::getService('profile')->timeline()): ?> profile_timeline_header<?php endif;  if (( empty ( $this->_aVars['aUser']['cover_photo'] ) && ( ! isset ( $this->_aVars['aUser']['cover_photo_id'] ) || $this->_aVars['aUser']['cover_photo_id'] < 1 ) ) || ( Phpfox ::isUser() && ! Phpfox ::getService('user.privacy')->hasAccess('' . $this->_aVars['aUser']['user_id'] . '' , 'profile.view_profile' ) )): ?> no_cover_photo <?php endif; ?>">
...
<?php if (substr ( $this->_aVars['aSubMenu']['url'] , -4 ) == '.add' || substr ( $this->_aVars['aSubMenu']['url'] , -7 ) == '.upload' || substr ( $this->_aVars['aSubMenu']['url'] , -8 ) == '.compose'): ?>
...
<?php if (( isset ( $this->_aVars['aUser']['is_online'] ) && $this->_aVars['aUser']['is_online'] != 0 ) || $this->_aVars['aUser']['is_friend'] === 2 || $this->_aVars['aUser']['is_friend'] === 3): ?>
...
<?php endif; ?>
<?php if ($this->_aVars['aUser']['is_online'] && $this->_aVars['aUser']['user_id'] != Phpfox ::getUserId()): ?>
