...
<?php if ($this->_aPhpfoxVars['iteration']['feedlinks'] == 3 && Phpfox ::getService('wall.feed')->timeline()): ?>
...
<?php if (( $this->_aVars['aFeedStatusLink']['no_profile'] && ! isset ( $this->_aVars['bFeedIsParentItem'] ) && ( ! defined ( 'PHPFOX_IS_USER_PROFILE' ) || ( defined ( 'PHPFOX_IS_USER_PROFILE' ) && isset ( $this->_aVars['aUser']['user_id'] ) && $this->_aVars['aUser']['user_id'] == Phpfox ::getUserId()))) || ! $this->_aVars['aFeedStatusLink']['no_profile']): ?>
					<li>
						<a href="#" style="background-image:url('<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'feed/'.$this->_aVars['aFeedStatusLink']['icon'].'','return_url' => true)); ?>'); background-repeat:no-repeat; background-position:<?php if (Phpfox ::getService('wall.feed')->timeline() && $this->_aPhpfoxVars['iteration']['feedlinks'] >= 3): ?>5px center<?php else: ?>center left<?php endif; ?>;" rel="global_attachment_<?php echo $this->_aVars['aFeedStatusLink']['module_id']; ?>"<?php if ($this->_aVars['aFeedStatusLink']['no_input']): ?> class="no_text_input"<?php endif; ?>>
							<div>
...
<?php if ($this->_aPhpfoxVars['iteration']['feedlinks'] == count ( $this->_aVars['aFeedStatusLinks'] ) && Phpfox ::getService('wall.feed')->timeline()): ?>
				</ul>
			</li>			
<?php endif; ?>
...
<?php endif; ?>
		<div class="activity_feed_form_holder">		
			...
			<div class="global_attachment_holder_section" id="global_attachment_status" style="display:block;">
				<div id="js_status_attachment_link_cancel" class="link_attachment_cancel_link p_4 t_right"><a href="#" onclick="$Core.cancelParseLinkInFeed(); return false;"><?php echo Phpfox::getPhrase('link.cancel'); ?></a></div>
				...
				<!-- Adv Wall -->
				<div class="_uiPostComposer">
					<div class="_uiMentionTypeAheadContainer" id="user_status_area">
						<div class="_uiMentionHighlighterArea _uiCommentHighlighterArea">
							<div class="innerWrap">
								<span class="_uiMentionHighlighter"></span>
							</div>
						</div>
						<div class="_uiTypeaheaMentiondArea">
							<div class="innerWrap">
								<textarea placeholder="<?php if (isset ( $this->_aVars['aFeedCallback']['module'] ) || defined ( 'PHPFOX_IS_USER_PROFILE' )):  echo Phpfox::getPhrase('feed.write_something');  else:  echo Phpfox::getPhrase('feed.what_s_on_your_mind');  endif; ?>" <?php if (isset ( $this->_aVars['aPage'] )): ?> id="pageFeedTextarea" <?php else: ?> <?php if (isset ( $this->_aVars['aEvent'] )): ?> id="eventFeedTextarea" <?php else: ?> <?php if (isset ( $this->_aVars['bOwnProfile'] ) && $this->_aVars['bOwnProfile'] == false): ?>id="profileFeedTextarea" <?php endif;  endif;  endif; ?> cols="60" rows="8" name="val[user_status_plain_text]" class="textarea_post_composer textarea_post_user_status _uiMentionTypeahead textareaNoResize"><?php if (isset ( $this->_aVars['aFeedCallback']['module'] ) || defined ( 'PHPFOX_IS_USER_PROFILE' )):  echo Phpfox::getPhrase('feed.write_something');  else:  echo Phpfox::getPhrase('feed.what_s_on_your_mind');  endif; ?></textarea>
							</div>
						</div>
						<input type="hidden" id="input_hidden_user_status" name="val[user_status]" class="_uiMentionHidden"/>
					</div>
				</div>
				<!-- Adv Wall -->
...
<?php if ($this->_aVars['bLoadCheckIn']): ?>
				<div id="js_location_input">
					...
					<a href="#" onclick="$Core.Feed.resetLocation(); return false;">Not here?</a>
					<a href="#" onclick="$Core.Feed.cancelCheckIn(); return false;">Cancel</a>
				</div>
<?php endif; ?>
			...
			<div class="activity_feed_form_button_status_info">
				<!-- Adv Wall -->
				<div class="_uiPostComposer">
					<div class="_uiMentionTypeAheadContainer" id="user_info_area">
						<div class="_uiMentionHighlighterArea _uiCommentHighlighterArea">
							<div class="innerWrap">
								<span class="_uiMentionHighlighter"></span>
							</div>
						...
						<div class="_uiTypeaheaMentiondArea">
							<div class="innerWrap">
								<textarea id="activity_feed_textarea_status_info" name="val[status_info_text]" class="textarea_post_composer _uiMentionTypeahead textareaNoResize" cols="60" rows="8" name="val[status_info]"></textarea>
							</div>
						</div>
						<input type="hidden" id="input_hidden_user_info" name="val[status_info]" class="_uiMentionHidden"/>
					</div>
				</div>
				<!-- Adv Wall -->
			</div>
...
<?php endif; ?>
<?php if (( ( defined ( 'PHPFOX_IS_PAGES_VIEW' ) && $this->_aVars['aPage']['is_admin'] && Phpfox ::getService('wall.feed')->timeline()) || ( defined ( 'PHPFOX_IS_USER_PROFILE' ) && isset ( $this->_aVars['aUser']['user_id'] ) && $this->_aVars['aUser']['user_id'] == Phpfox ::getUserId() && Phpfox ::getService('wall.feed')->timeline() && Phpfox ::getParam('feed.can_add_past_dates')))): ?>
							<li>
...
<?php if ($this->_aVars['bLoadCheckIn']): ?>
								<?php
						Phpfox::getLib('template')->getBuiltFile('wall.block.checkin');						
						?>						
<?php endif; ?>
						</ul>
						<div class="clear"></div>
...
<?php endif; ?>
<?php if (( ( defined ( 'PHPFOX_IS_PAGES_VIEW' ) && $this->_aVars['aPage']['is_admin'] ) || ( defined ( 'PHPFOX_IS_USER_PROFILE' ) && isset ( $this->_aVars['aUser']['user_id'] ) && $this->_aVars['aUser']['user_id'] == Phpfox ::getUserId() && Phpfox ::getService('wall.feed')->timeline() && Phpfox ::getParam('feed.can_add_past_dates')))): ?>
