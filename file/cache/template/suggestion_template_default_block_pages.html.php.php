...
<?php else: ?>
        		<a class="large_item_image" href="<?php echo Phpfox::permalink('pages', $this->_aVars['aRow']['page_id'], $this->_aVars['aRow']['title'], false, null, (array) array (
)); ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aRow']['title']); ?>">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aRow']['image_server_id'],'return_url' => false,'path' => 'core.url_pic','file' => 'pages/'.$this->_aVars['aRow']['image_path'],'suffix' => '_50','max_width' => 50)); ?>
        		</a>
<?php endif; ?>
        </p>
        <p style="padding: 0 0 5px 60px; border-bottom:1px solid #f2f2f2;">
            <span class="l13">
                <a target="_blank" rel="<?php echo $this->_aVars['aRow']['is_right']; ?>" id="<?php echo $this->_aVars['aRow']['link']; ?>" href="<?php echo $this->_aVars['aRow']['link']; ?>" class="suggestion-join-pages" style="font-weight: bold;"><?php echo $this->_aVars['aRow']['title']; ?>
...
<?php if ($this->_aVars['aRow']['isAllowSuggestion']): ?>
                    <a target="_blank" id="<?php echo $this->_aVars['aRow']['page_id']; ?>" class="suggest-page" href="#" rel=""><?php echo Phpfox::getPhrase('suggestion.suggest_to_friends_2'); ?></a> 
<?php endif; ?>
...
<?php if ($this->_aVars['aRow']['display_join_link']): ?>
                    <a target="_blank" rel="<?php echo $this->_aVars['aRow']['is_right']; ?>" id="<?php echo $this->_aVars['aRow']['link']; ?>" href="<?php echo $this->_aVars['aRow']['link']; ?>" class="suggestion-join-pages"><?php echo Phpfox::getPhrase('suggestion.join_pages'); ?>
                        <span style="display:none"><?php echo $this->_aVars['aRow']['encode_link']; ?></span>
                        <span class="divIUserId" style="display:none;"><?php echo $this->_aVars['aRow']['user_id']; ?></span>
                        <span class="title" style="display:none;"><?php echo $this->_aVars['aRow']['title']; ?></span>
                    </a>
...
<?php endif; ?>
        ...
        <p id="suggestion-page-<?php echo $this->_aVars['aRow']['page_id']; ?>" style="display:none"><?php echo $this->_aVars['aRow']['page_id']; ?>++<?php echo $this->_aVars['aRow']['link']; ?>++<?php echo base64_encode($this->_aVars['aRow']['title']); ?></p>
