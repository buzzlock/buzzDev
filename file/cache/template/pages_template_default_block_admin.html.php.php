...
<?php if (count((array)$this->_aVars['aPageAdmins'])):  $this->_aPhpfoxVars['iteration']['pageadmins'] = 0;  foreach ((array) $this->_aVars['aPageAdmins'] as $this->_aVars['aPageAdmin']):  $this->_aPhpfoxVars['iteration']['pageadmins']++; ?>

		<li>
			<div class="block_listing_image">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aPageAdmin'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
			</div>
			<div class="block_listing_title" style="padding-left:56px;">
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aPageAdmin']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aPageAdmin']['user_name'], ((empty($this->_aVars['aPageAdmin']['user_name']) && isset($this->_aVars['aPageAdmin']['profile_page_id'])) ? $this->_aVars['aPageAdmin']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getService('user')->getCurrentName($this->_aVars['aPageAdmin']['user_id'], $this->_aVars['aPageAdmin']['full_name']), 40, '...') . '</a></span>'; ?>
<?php if ($this->_aPhpfoxVars['iteration']['pageadmins'] == 1): ?>
				<div class="extra_info">
<?php echo Phpfox::getPhrase('pages.founder'); ?>
				</div>
<?php endif; ?>
			</div>
			<div class="clear"></div>
