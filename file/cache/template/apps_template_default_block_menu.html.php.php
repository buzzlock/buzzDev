...
<?php if (count ( $this->_aVars['aInstalledApps'] ) > $this->_aVars['iPageLimit']): ?>
	<div class="bottom">
		<ul>
			<li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('apps', array('view' => 'installed')); ?>"><?php echo Phpfox::getPhrase('pages.view_more'); ?></a></li>
		</ul>
	</div>
<?php endif; ?>
<?php endif; ?>
