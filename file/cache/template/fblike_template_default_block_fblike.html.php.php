...
<?php if (empty ( $this->_aVars['sUrl'] )): ?>
   <div class="error_message"><?php echo Phpfox::getPhrase('fblike.must_set_the_facebook_page_url_in_admincp'); ?></div>
<?php else: ?>
   <script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script>
   
   <fb:like-box class="fblike" data-href="<?php echo $this->_aVars['sUrl']; ?>" colorscheme="<?php echo $this->_aVars['sColor']; ?>" show_faces="<?php echo $this->_aVars['sFace']; ?>" stream="<?php echo $this->_aVars['sStream']; ?>" header="<?php echo $this->_aVars['sShowHeader']; ?>" force_wall="<?php echo $this->_aVars['sForceWall']; ?>" <?php if ($this->_aVars['iWidth'] > 0): ?> width="<?php echo $this->_aVars['iWidth']; ?>" <?php endif; ?> <?php if ($this->_aVars['iHeight'] > 0): ?> height="<?php echo $this->_aVars['iHeight']; ?>" <?php endif; ?>></fb:like-box>
