 ...
 */
 if ($this->_aVars['aMostViewListing'] !== NULL):  echo '
<style type="text/css">
...
<?php if (count((array)$this->_aVars['aMostViewListing'])):  foreach ((array) $this->_aVars['aMostViewListing'] as $this->_aVars['iKey'] => $this->_aVars['aListing']): ?>
...
<?php endif; ?>
        ...
        <div class="row_title_info">
            <a class="advlink" href="<?php echo $this->_aVars['aListing']['url']; ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('phpfox.parse.output')->parse($this->_aVars['aListing']['title'])); ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aListing']['title'], 50, '...'), 25); ?></a>
