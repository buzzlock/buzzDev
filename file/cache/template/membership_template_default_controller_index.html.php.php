...
<?php /* Cached: March 16, 2014, 7:26 pm */ ?>
<!DOCTYPE html>
<html>	
	<body>
	<div id="bizbody">		
		<div id="buzzbiz_1">
			<a href="#" id="pop1"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'buzzbiz/buzzbiz1.png','alt' => '1. Signup		- Free to join.')); ?></a>
		</div>		
		<div id="buzzbiz_2">
			<a href="#" id="pop2"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'buzzbiz/buzzbiz2.png','alt' => '2. Buzz	  - Share your link.')); ?></a>
		</div>		
		<!--<div id="buzzbiz_3">
			<a href="#" id="pop3"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'buzzbiz/buzzbiz3.png','alt' => '3. Lock	  - Lock-in your income.')); ?></a>
		</div>-->
		<div id="buzzbiz_form">			
			<form  method="post" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('membership.index'); ?>" autocomplete="off">
<?php echo '<div><input type="hidden" name="' . Phpfox::getTokenName() . '[security_token]" value="' . Phpfox::getService('log.session')->getToken() . '" /></div>'; ?>
				<br>
				<div id="buzzbiz_logo"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'buzzbiz/buzzbizLogo.png')); ?></div>
				<div class="separate"></div>
				<span id="buzzbiz_error">
					<strong><?php echo $this->_aVars['error']; ?></strong>
				</span><br/>	
				<div class="table">
					<div class="table_left">
						<label for="first_name"><?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.first_name'); ?>: <a href="#" id="name">[ ? ]</a></label>
					</div>
				...
				<div class="table">
					<div class="table_left">			
						<label for="last_name">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.last_name'); ?>:
						</label>
					</div>
				...
				<div class="table">
					<div class="table_left">
						<label for="address">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Address: <a href="#" id="address">[ ? ]</a>
						</label>
					</div>
					<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
					<label for="country"><?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.location'); ?>:</label>
				</div>
				<div class="table_right">
...
<?php Phpfox::getBlock('core.country-child', array('country_force_div' => true)); ?>
			...
			<div class="table">
				<div class="table_left">
					<label for="city">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>City:
					</label>
				</div>
				<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
					<label for="zip">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Postal/Zip Code:
					</label>
				</div>
				<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
					<label for="password1">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.password'); ?>: <a href="#" id="pass">[ ? ]</a>
					</label>
				</div>							
				<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
					<label for="password2">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Confirm Password:
					</label>
				</div>
				<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Where do we pay you? <a href="#" id="gate">[ ? ]</a>
				</div>
				<div class="table_left">
...
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Account Email:
			...
			<div class="table">						
				<div class="table_left">
					<label for="ssn1">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>SSN or TIN: <a href="#" id="ssn">[ ? ]</a>
					</label>
				</div>
				<div class="table_right">
			...
			<div class="table">
				<div class="table_left">
					<label for="ssn2">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Confirm SSN or TIN:
					</label>
				</div>
				<div class="table_right">
			...
			<div class="table"> 
				...
				<div class="table_left">
					<a href="<?php echo $this->_aVars['irs']; ?>" target="_blank"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'buzzbiz/irsGov.png')); ?></a>
				</div>
			</div>
			<div class="separate">
			</div>
			<div class="table">
				<div class="table_left">
					...
					<label for="terms">
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>I've read and agree to the <a href="#" id="term">Terms</a>.
					</label>
				</div>
			</div>
			<div class="table">
				<div class="table_left">
					<div class="p_4">
						<span id="buzzbiz_required_text">
							<strong><?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Required</strong>
						</span><br>
						<span id="buzzbiz_error">
							<strong><?php echo $this->_aVars['error']; ?></strong>
						</span>	
