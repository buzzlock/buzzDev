...
<html>	
	<body>
		<div id="buzzbiz_BG">
			<img src="<?php echo $this->_aVars['buzzbizBG']; ?>" alt="">
		</div>		
		<div id="buzzbiz_1">
			<a href="#" id="pop1"><img src="<?php echo $this->_aVars['buzzbiz1']; ?>" alt="1. Signup - Free to join."></a>
		</div>		
		<div id="buzzbiz_2">
			<a href="#" id="pop2"><img src="<?php echo $this->_aVars['buzzbiz2']; ?>" alt="2. Buzz	  - Share your link."></a>
		</div>		
		<div id="buzzbiz_3">
			<a href="#" id="pop3"><img src="<?php echo $this->_aVars['buzzbiz3']; ?>" alt="3. Lock	  - Lock-in your income."></a>
		</div>
		<div id="buzzbiz_form">			
...
<?php echo '<div><input type="hidden" name="' . Phpfox::getTokenName() . '[security_token]" value="' . Phpfox::getService('log.session')->getToken() . '" /></div>'; ?>
				<br>
				<div id="buzzbiz_logo">
					<img src="<?php echo $this->_aVars['buzzbizLogo']; ?>" alt="Buzzbiz">
				</div>
				<div class="separate">
				</div>
...
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif;  echo Phpfox::getPhrase('user.first_name'); ?>: <a href="#" id="name">[ ? ]</a>
						</label>
					</div>
...
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Account Email:
			...
			<div class="table">
				...
				<div class="table_left">								
						<a href="<?php echo $this->_aVars['paypal']; ?>" target="_blank"><img src="<?php echo $this->_aVars['paypalLogo']; ?>" alt="Papal Sign up" width="140"></a>								
				</div>
				<div class="table_left">								
					<a href="<?php echo $this->_aVars['payza']; ?>" target="_blank"><img src="<?php echo $this->_aVars['payzaLogo']; ?>" alt="Payza Sign up" width="140"></a>								
				</div>
			</div>
			<div class="separate">
			</div><br/>
...
<?php if (Phpfox::getParam('core.display_required')): ?><span class="required"><?php echo Phpfox::getParam('core.required_symbol'); ?></span><?php endif; ?>Confirm SSN or TIN:
			...
			<div class="table"> 
				...
				<div class="table_left">
					<a href="<?php echo $this->_aVars['irs']; ?>" target="_blank"><img src="<?php echo $this->_aVars['irsLogo']; ?>" alt="IRS TIN"></a>
				</div>
			</div>
			<div class="separate">
			</div>
