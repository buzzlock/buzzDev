...
<?php /* Cached: March 8, 2014, 8:59 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
{
    position: relative;
    right: ';  echo $this->_aVars['iMarginRight'];  echo 'px;
...
<ul id="opensocialconnect_holder_header"  <?php if (Phpfox ::getLib('module')->getFullControllerName()=='user.login'): ?>style="position: inherit; border: 1px solid #CFCFCF; padding: 2px; margin-top: 5px; width:<?php echo $this->_aVars['iWidth']; ?>px"<?php endif; ?>>
...
<?php if ($this->_aPhpfoxVars['iteration']['opr'] == $this->_aVars['iLimitView']): ?>
            <li><a href="javascript:void(0);" title="" class="js_item_active_link" onclick="viewmore();"><img src="<?php echo $this->_aVars['sCoreUrl']; ?>module/opensocialconnect/static/image/more.png" alt="" /></a>
<?php endif; ?>
<?php endif; ?>
<?php endforeach; endif; ?>
</ul>
