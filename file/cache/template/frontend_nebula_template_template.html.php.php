...
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  $sController = "membership.prime";  if ( Phpfox::getLib("template")->shouldLoadDelayed("membership.prime") == true ): ?>
