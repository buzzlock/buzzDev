...
<ul class="profile_project_content">
    <li>
<?php echo $this->_aVars['iPercent']; ?>% <?php echo Phpfox::getPhrase('profilecompleteness.profile_completeness'); ?>
    </li>
    <li>
        <div style="background-color: <?php echo $this->_aVars['colorbackground']; ?>;">
...
<?php if ($this->_aVars['PercentTotal'] != 100): ?>
    <li>
<?php echo Phpfox::getPhrase('profilecompleteness.next'); ?>: <a href="<?php if ($this->_aVars['isPhoTo'] == 1):  echo Phpfox::getLib('phpfox.url')->makeUrl('user.profile', array('group' => $this->_aVars['iGroup_id']));  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('user.photo');  endif; ?>">+ <?php echo $this->_aVars['Key']; ?> (+<?php echo $this->_aVars['PercentValue']; ?>%)</a>
    </li>
    <li>
        <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('user.profile'); ?>"><?php echo Phpfox::getPhrase('profilecompleteness.update_profile'); ?></a>
    </li>
<?php endif; ?>
</ul>
</div>
