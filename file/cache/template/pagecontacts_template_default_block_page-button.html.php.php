...
<?php if (! $this->_aVars['bIsSetting']): ?>
		<input type="button" value="<?php echo Phpfox::getPhrase('pagecontacts.contact_us'); ?>" class="yn_pagecontact_button" onclick="tb_show('<?php echo Phpfox::getPhrase('pagecontacts.contact_us'); ?>', $.ajaxBox('pagecontacts.popup', 'height=300&amp;width=550&amp;iPageId=<?php echo $this->_aVars['iPageId']; ?>')); return false;" />
<?php else: ?>
		<input type="button" value="<?php echo Phpfox::getPhrase('pagecontacts.contact_us'); ?>" class="yn_pagecontact_button" onclick="window.location.href ='<?php echo $this->_aVars['sLink']; ?>'; return false;" />
<?php endif; ?>
	<div class="clear"></div>
</div>
