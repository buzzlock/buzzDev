...
<link rel="stylesheet" type="text/css" href="<?php echo $this->_aVars['core_path']; ?>module/resume/static/css/default/default/resume-completeness.css">
<?php if (! $this->_aVars['bNoResume']): ?>
<ul class="yns-profile-complete">
<?php if (count((array)$this->_aVars['aResumes'])):  foreach ((array) $this->_aVars['aResumes'] as $this->_aVars['aResume']): ?>
	<li>
		<strong><?php echo Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aResume']['headline'], 30, '...'); ?></strong>
<?php if ($this->_aVars['aResume']['is_completed'] && $this->_aVars['aResume']['is_published'] && $this->_aVars['aResume']['status'] == 'approved'): ?>
			<sup><?php echo Phpfox::getPhrase("resume.published"); ?></sup>
			<a href="<?php echo Phpfox::permalink('resume.add', 'id_'.$this->_aVars['aResume']['resume_id'], null, false, null, (array) array (
)); ?>"><?php echo Phpfox::getPhrase("resume.update"); ?></a>
<?php else: ?>
			<a href="<?php echo Phpfox::permalink('resume.add', 'id_'.$this->_aVars['aResume']['resume_id'], null, false, null, (array) array (
)); ?>"><?php echo Phpfox::getPhrase("resume.update"); ?></a>
			<div class="clear"></div>
			<span class="progress-meter" title="<?php echo $this->_aVars['aResume']['completed_percent']; ?>% <?php echo Phpfox::getPhrase('resume.complete'); ?>">
				<span class="has-progress" style="width:<?php echo $this->_aVars['aResume']['completed_percent']; ?>%"></span>
			</span>	
<?php if ($this->_aVars['aResume']['next_suggestion']): ?>
<?php echo $this->_aVars['aResume']['next_suggestion']; ?>
<?php endif; ?>
<?php endif; ?>
		<div class="clear"></div>
	</li>
...
<p class="yns-viewall"><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('resume.view_my'); ?>"><?php echo Phpfox::getPhrase('resume.view_all'); ?></a></p>
<?php else: ?>
<?php echo Phpfox::getPhrase("resume.no_created_resume", array('link' => $this->_aVars['sCreateLink']));  endif; ?>
