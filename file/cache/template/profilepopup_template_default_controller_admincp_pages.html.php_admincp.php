...
<?php if (count ( $this->_aVars['aAllItems'] )): ?>
        <div class="p_4"><span style="font-weight: bold; text-decoration: underline; font-size: 15px;"><?php echo Phpfox::getPhrase('profilepopup.notice'); ?></span>: <?php echo Phpfox::getPhrase('profilepopup.pages_global_settings_info'); ?></div>
        <form id="globalSettings" method="post" action="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('admincp.profilepopup.pages'); ?>">
...
<?php else: ?>
        <div class="p_4">
<?php echo Phpfox::getPhrase('profilepopup.no_pages_global_settings'); ?>
        </div>
<?php endif; ?>
