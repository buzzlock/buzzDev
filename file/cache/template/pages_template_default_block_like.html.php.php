...
<?php if (count((array)$this->_aVars['aMembers'])):  $this->_aPhpfoxVars['iteration']['members'] = 0;  foreach ((array) $this->_aVars['aMembers'] as $this->_aVars['iKey'] => $this->_aVars['aMember']):  $this->_aPhpfoxVars['iteration']['members']++; ?>

		<li>
			<div class="block_listing_image">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aMember'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
			</div>
			<div class="block_listing_title" style="padding-left:56px;">
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aMember']['user_name'] . '" itemprop="author"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aMember']['user_name'], ((empty($this->_aVars['aMember']['user_name']) && isset($this->_aVars['aMember']['profile_page_id'])) ? $this->_aVars['aMember']['profile_page_id'] : null))) . '" rel="author" >' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getService('user')->getCurrentName($this->_aVars['aMember']['user_id'], $this->_aVars['aMember']['full_name']), 12, true), Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>'; ?>
			</div>
			<div class="clear"></div>
		</li>
<?php endforeach; endif; ?>
...
<?php echo Phpfox::getPhrase('pages.no_members_yet'); ?>
	</div>
<?php endif; ?>
<?php else: ?>
	<div class="global_like_number">
<?php echo number_format($this->_aVars['aPage']['total_like']); ?>
	</div>
	<div class="global_like_link">	
		<a href="#" onclick="return $Core.box('like.browse', 400, 'type_id=pages&amp;item_id=<?php echo $this->_aVars['aPage']['page_id']; ?>&amp;force_like=1');"><?php if ($this->_aVars['aPage']['total_like'] == 1):  echo Phpfox::getPhrase('pages.person_likes_this');  else:  echo Phpfox::getPhrase('pages.people_like_this');  endif; ?></a>
	</div>
