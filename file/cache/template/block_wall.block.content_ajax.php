...
<?php if (! isset ( $this->_aVars['aFeed']['feed_mini'] ) && ! Phpfox ::getService('wall.feed')->timeline()): ?>
...
<?php Phpfox::getBlock('wall.comment', array()); ?>
<?php else: ?>
			<?php
						Phpfox::getLib('template')->getBuiltFile('wall.block.comment');						
						?>		
<?php endif; ?>
