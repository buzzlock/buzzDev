...
{oChildrenCategory.show();}});});$('.hover_action').each(function(){$(this).parents('.js_outer_video_div:first').css('width',this.width+'px');});$('.full_name a, .js_allow_video_click a').click(function(){window.location.href=$(this).attr('href');return false;});$('.video_info_box').click(function(){if(!$('.video_info_box').hasClass('video_info_box_is_clicked'))
{$Core.processVideoInfo($('.video_info_toggle'));}
return false;});$('.video_info_toggle').click(function(){$Core.processVideoInfo(this);return false;});$('#js_block_bottom_link_1').click(function(){$(this).parent().find('.ajax_image').show();$('#js_video_related_page_form').ajaxCall('videochannel.getMoreRelated','',false,'GET');return false;});$('.js_edit_video_form').keydown(function(){$Core.resizeTextarea($(this));});}
