<div id="js_register_step1">
		...
		<div class="table">
			<div class="table_right">
				<input type="text" name="val[full_name]" id="full_name" value="{value type='input' id='full_name'}" size="30" placeholder="{phrase var='user.full_name'}"/>
			</div>			
		</div>
		{/if}
		...
		<div class="table">
			<div class="table_right">
				<input type="text" placeholder="{phrase var='user.email'}" name="val[email]" id="email" value="{value type='input' id='email'}" size="30" />
			</div>			
		</div>
		{if Phpfox::getParam('user.reenter_email_on_signup')}
		<div class="table">
		...
		<div class="table">
			<div class="table_right">
				{if isset($bIsPosted)}
				<input type="password" placeholder="{phrase var='user.password'}" name="val[password]" id="password" value="{value type='input' id='password'}" size="30" />
				{else}
				<input type="password" placeholder="{phrase var='user.password'}" name="val[password]" id="password" value="" size="30" />
				{/if}
			</div>			
		</div>
