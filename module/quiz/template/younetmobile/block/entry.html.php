	...
	{if !isset($bIsViewingQuiz)}
		<div class="row_title">
			...
			<div class="row_title_image">
                ...
                {img thickbox=true server_id=$aQuiz.server_id title=$aQuiz.title path='quiz.url_image' file=$aQuiz.image_path suffix=$sSuffix max_width='50' max_height='quiz.quiz_max_image_pic_size'}
            </div>				
			</div>
