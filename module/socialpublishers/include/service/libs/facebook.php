 ...
 */
class FacebookSPLNApiException extends Exception
{
  /**
...
/**
 * Provides access to the FacebookSPLN Platform.
 *
 * @author Naitik Shah <naitik@facebook.com>
 */
class FacebookSPLN
{
   ...
   */
  public function getLoginUrl($params=array(),$nextPage) {
    $cancelUrl=$nextPage."&sccreturn=0";
    return $this->getUrl(
      'www',
      'login.php',
      array_merge(array(
   ...
   * @throws FacebookSPLNApiException
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new FacebookSPLNApiException($result);
    }
    return $result;
  }
  ...
  protected function _graph($path, $method='GET', $params=array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new FacebookSPLNApiException($result);
      switch ($e->getType()) {
        // OAuth 2.0 Draft 00 style
        case 'OAuthException':
        // OAuth 2.0 Draft 10 style
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new FacebookSPLNApiException(array(
