...
Site Name</setting>
  ...
  1 => '2|core.her|profile.female|core.herself|female',
		...
		<setting group="formatting" module_id="core" is_hidden="0" type="large_string" var_name="html_purifier_allowed_html" phrase_var_name="setting_html_purifier_allowed_html" ordering="9" version_id="3.6.0rc1"><![CDATA[br,p,em,u,ul,li,font,ol,div[class|style],span[style],blockquote,strike,b,strong,img[src|alt|class|height|width],a[href|rel|target],iframe[src|width|height|frameborder],object[width|height|data],param[name|value],embed[src|type|allowscriptaccess|allowfullscreen|width|height]]]></setting>
