...
<div class="general">
	<div class="table" style="height:30px;border-bottom:0px;">
	...
	<div class="table" style="height:120px;border-bottom:0px;">
	    <div class="table_left" style="width:35%; float:left;">
...
<div class="clear"> </div>
<div class="emails">
	<div class="table" style="border-bottom:0px;">
        ...
        <div class="clear"> </div>
	<div class="table" style="height:10px;border-bottom: 0px;">
