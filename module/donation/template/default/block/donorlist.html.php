		...
		<div class="label_flow" style="height:200px;">
			...
			<div style="position: relative" class="row2" id = 'yn_donor_{$aFriend.donation_id}'>
				...
				{if !$aFriend.not_show_money}
					<span  style="font-weight:bold; position: absolute; top:12px; left:250px;" id="js_friend_{$aFriend.user_id}"> {phrase var='donation.donated'} {$aFriend.quanlity} {$aFriend.currency}</span>
				{else}
