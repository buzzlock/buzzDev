...
<form method="post" action="#" onsubmit="js_box_remove(this); $(this).ajaxCall('fundraising.inviteFriends'); return false;">
    ...
    <div style="width:100%; position:relative;">				
            ...
            <div class="p_top_8">
                    <input type="submit" name="val[invite]" value="{phrase var='fundraising.send_invitations'}" class="button" />
            </div>
            {if Phpfox::isModule('friend')}
...
<script type="text/javascript">
    $Behavior.setupInviteLayout = function() {l}
         $("#js_friend_search_content").append('<div class="clear" style="padding:5px 0px 10px 0px;"><input type="button" onclick="$(\'input.checkbox\').attr(\'checked\', \'checked\');" value="{phrase var='fundraising.select_all'}" /> <input type="button" onclick="$(\'input.checkbox\').removeAttr(\'checked\');" value="{phrase var='fundraising.un_select_all'}"/></div>');
