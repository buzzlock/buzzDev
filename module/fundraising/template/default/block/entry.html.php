	...
	<div class="row_title_image_header">
		...
		{elseif $aItem.status == 4}
	     ...
	     <div class="ynfr_close_link">
          ...
          {else}
		<div class="js_featured_fundraising yn_featured_link"{if !$aItem.is_featured} style="display:none;"{/if}>
	...
	<div class="row_title_image_header_body">		
		...
		{/if}	
			<div class="fundraising_content">
				...
				{module name='tag.item' sType=$sTagType sTags=$aItem.tag_list iItemId=$aItem.campaign_id iUserId=$aItem.user_id}
				{/if}
