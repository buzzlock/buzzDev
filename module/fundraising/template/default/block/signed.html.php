...
{foreach from=$aSigned key=iKey item=aFundraising name=Signed}
...
<div class="clear"></div>
{if $iTotal > 4}
<div style="padding-top: 10px; text-align:right;"><a href="{url link='fundraising' status='0' view='listing' sort='most-signed'}">{phrase var='fundraising.view_all'}</a></div>
{/if}
</div>
