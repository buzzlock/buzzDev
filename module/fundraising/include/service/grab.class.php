...
class Fundraising_Service_Grab extends Phpfox_Service
{
	...
	public function get($sUrl)
	{
		...
		{		
			...
			else 
			{
				...
				if (!$this->_aData['site_id'])
				{
					...
					return Phpfox_Error::set(Phpfox::getPhrase('fundraising.not_a_valid_site_valid_sites_asites', array('aSites' => implode(', ', $aSites))));
				}
			}
		...
		return Phpfox_Error::set(Phpfox::getPhrase('fundraising.please_provide_a_valid_url_for_your_video'));
	}
