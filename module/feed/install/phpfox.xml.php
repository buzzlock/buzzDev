...
For this to work you need to have entered the Google API Key (<setting>google_api_key</setting></info>) or the IP Info DB Key (<setting>ip_infodb_api_key</setting>)]]></phrase>
		...
		<phrase module_id="feed" version_id="3.7.0beta1" var_name="user_setting_can_sponsor_feeds" added="1375264862">Can members of this user group sponsor feeds?</phrase>
	...
	<user_group_settings>
		...
		<setting is_admin_setting="0" module_id="feed" type="boolean" admin="false" user="false" guest="false" staff="false" module="feed" ordering="0">can_sponsor_feeds</setting>
