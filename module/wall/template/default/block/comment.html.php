						...
						<div class="_uiCommentComposer">
							<div class="_uiMentionTypeAheadContainer">
								...
								<div class="_uiTypeaheaMentiondArea">
									<div class="innerWrap">
										<textarea cols="60" rows="1" name="val[plain_text]" class="js_comment_feed_textarea _uiMentionTypeahead text" id="js_feed_comment_form_textarea_{$aFeed.feed_id}">{if isset($sFeedType) &&  $sFeedType == 'view' && Phpfox::getUserParam('comment.wysiwyg_on_comments') && Phpfox::getParam('core.wysiwyg') == 'tiny_mce'}{else}{phrase var='feed.write_a_comment'}{/if}</textarea>
										<div style="position:absolute;" class="js_feed_comment_process_form">{phrase var='feed.adding_your_comment'}{img theme='ajax/add.gif'}</div>
									</div>
								</div>
