...
class Wall_Component_Controller_Photo_Frame extends Phpfox_Component 
{
	...
	{		
		...
		if ($fn) {
			...
			$sHTML5TempFile = md5(PHPFOX_DIR_CACHE . $fn . uniqid());
		...
		$oServicePhotoProcess = Phpfox::getService('wall.photo.process');
		$aImages = array();	
		$aFeed = array();
		$iFileSizes = 0;
		$iCnt = 0;
