{if count($aNewPlaylists)}
    ...
    <div class="playlist_musicsharing">
        ...
        <div class="content_right_info">
            <ul>
                <li> <a class="title_thongtin2" href="{if !isset($aParentModule)}{url link='musicsharing.listen.playlist_'.$aPlaylist.playlist_id}{else}{url link=$aParentModule.module_id.".".$aParentModule.item_id.'.musicsharing.listen.playlist_'.$aPlaylist.playlist_id}{/if}">{$aPlaylist.title} </a> </li>
                <li>
