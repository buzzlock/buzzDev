...
{if count($aTopAlbums)}
    {foreach from=$aTopAlbums item=aAlbum name=anew} 
        <li>
            <a target="_parent" href="{if !isset($aParentModule)}{url link='musicsharing.listen' album=$aAlbum.album_id}{else}{url link=$aParentModule.module_id.".".$aParentModule.item_id.'.musicsharing.listen' album=$aAlbum.album_id}{/if}">
