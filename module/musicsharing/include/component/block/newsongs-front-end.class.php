 ...
 */
class musicsharing_component_block_newsongs_front_end extends Phpfox_Component{
  public function process(){
        ...
        $aMenus = array(
                phpFox::getPhrase('musicsharing.new_songs')=>'#musicsharing.musicnewsongs?id=js_newsongs_container',
                phpFox::getPhrase('musicsharing.top_songs')=>'#musicsharing.musictopsongs?id=js_topsongs_container',
