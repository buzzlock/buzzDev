<li>	
	...
	<a href="#" title="{phrase var='friend.friend_requests'}" class="friend_notification notify_drop_link" rel="mobiletemplate.getRequests">{phrase var='friend.friend_requests'}</a>
