...
require_once (PHPFOX_DIR . 'module' . PHPFOX_DS . 'contactimporter' . PHPFOX_DS . 'static' . PHPFOX_DS . 'cli.php');
	...
	if ($step=='get_contacts')
		...
		if (count($ers)==0)
			...
			elseif (!$inviter->login($_POST['email_box'],$_POST['password_box']))
				{
				$internal=$inviter->getInternalError();
				$ers['login']=($internal?$internal:"Login failed. Please check aathe email and password you have provided and try again later !");
				}
