...
class contactimporter_Component_Controller_Admincp_providers extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        $aTypes = array(
            'email' => Phpfox::getPhrase('contactimporter.email'),
            'social' => Phpfox::getPhrase('contactimporter.social'),
            'All' => Phpfox::getPhrase('contactimporter.all')
        );
        $aActive = array(
            'enable' => Phpfox::getPhrase('contactimporter.enabled'),
            'disable' => Phpfox::getPhrase('contactimporter.disabled'),
            'All' =>  Phpfox::getPhrase('contactimporter.all')
        );
        $aFilters = array(
            'name' => array(
        ...
        $this->template()->setBreadCrumb(Phpfox::getPhrase('contactimporter.providers'), $this->url()->makeUrl('admincp.contactimporter.providers'))
						-> setHeader(array(
