...
<div class="p_4" align="center">  
    <input type="button" value="{phrase var='core.yes'}" class="button" onclick="newwindow=window.open('{$core_path}module/socialbridge/static/php/linkedin.php?callbackUrl={$sCallback}&bredirect=1','name','height=400,width=650,top=200,left=300');if (window.focus) newwindow.focus();tb_remove();" />      
