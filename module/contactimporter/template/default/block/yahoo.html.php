...
<div class="p_4" align="center">
  ...
  <input type="button" value="{phrase var='core.yes'}" class="button" onclick="window.location='{$sCentralizeUrl}?service=yahoo&login=1&security_token={$sSecurityToken}&token_name={$tokenName}&callbackUrl={$sCallback}','name','height=400,width=550';
        tb_remove();if (window.focus) newwindow.focus();tb_remove();redirect();" />        
