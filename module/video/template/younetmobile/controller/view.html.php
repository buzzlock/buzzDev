	...
	<div id="js_video_outer_body">	
		...
		{else}		
			{if isset($aVideo.youtube_video_url)}
				<iframe width="560" height="315" src="http://www.youtube.com/embed/{$aVideo.youtube_video_url}{if Phpfox::getParam('video.disable_youtube_related_videos')}?rel=0{/if}" frameborder="0" allowfullscreen></iframe>
			{else}
