...
class JobPosting_Service_Resume extends Phpfox_service
{
    ...
    private function _buildHtmlBasic()
    {
        ...
        {
            $sHtml .= '<div class="info"><!-- Category list --><div class="info_left">'.Phpfox::getPhrase('resume.categories').':</div><div class="info_right">';
        ...
        {
            $sHtml .= '<!-- Year of experience --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.years_of_experience').':</div><div class="info_right">';
        ...
        {
            $sHtml .= '<!-- Highest level --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.highest_level').': </div><div class="info_right">'.$this->_aVars['aResume']['level_name'].'</div></div>';
        }
        if ($this->_aVars['aLatestEducation'])
        {
            $sHtml .= '<!-- Education --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.education').': </div><div class="info_right">'.$this->_aVars['aLatestEducation']['degree'].', '.$this->_aVars['aLatestEducation']['field'].' '.Phpfox::getPhrase('resume.at').' '.$this->_aVars['aLatestEducation']['school_name'].'</div></div>';
        }
        ...
        {
            $sHtml .= '<!-- Authorized to work on --><div class="info"><div style="margin-bottom: 5px;"><strong>'.Phpfox::getPhrase('resume.authorized_to_work_on').'</strong></div>';
			if ($this->_aVars['aResume']['authorized_country_iso'])
            {
				$sHtml .= '<div class="info_left">'.Phpfox::getPhrase('resume.country').': </div><div class="info_right">'.Phpfox::getService('core.country')->getCountry($this->_aVars['aResume']['authorized_country_iso']);
            ...
            {              
				$sHtml .= '<div class="info_left">'.Phpfox::getPhrase('resume.location').': </div><div class="info_right">'.$this->_aVars['aResume']['authorized_location'].'</div>';
			}
			if ($this->_aVars['aResume']['authorized_other_level'])
            {
				$sHtml .= '<div class="info_left">'.Phpfox::getPhrase('resume.position').': </div><div class="info_right">'.$this->_aVars['aResume']['authorized_other_level'].'</div>';
			}
            elseif ($this->_aVars['aResume']['authorized_level_id'] > 0)
            {
                $sHtml .= '<div class="info_left">'.Phpfox::getPhrase('resume.position').': </div><div class="info_right">'.$this->_aVars['aResume']['authorized_position'].'</div>';
            }
			$sHtml .= '</div>';
        }
		if ($this->_aVars['turnonFields'])
        {
            ...
            if (count((array)$this->_aVars['aViewCustomFields']))
            {
                foreach ((array) $this->_aVars['aViewCustomFields'] as $this->_aVars['aCustomField'])
                {
                    ...
                    { 
						$sHtml .= '<div class="info_left">'.Phpfox::getPhrase($this->_aVars['aCustomField']['phrase_var_name']).': </div><div class="info_right">'.$this->_aVars['aCustomField']['value'].'</div>';
                    }
                }
            }
            $sHtml .= '</div></div>';
        ...
        {
            $sHtml .= '<!-- Phone --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.phone_number').':</div><div class="info_right">';
        ...
        {
            $sHtml .= '<!-- IM --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.im').':</div><div class="info_right"><p></p>';
        ...
        {
            $sHtml .= '<!-- Email --><div class="info"><div class="info_left">'.Phpfox::getPhrase('resume.email').':</div><div class="info_right"><p></p>';
    ...
    private function _buildHtmlAddition()
    {
        ...
        if (!empty($this->_aVars['aAddition']['email']) || !empty($this->_aVars['aAddition']['sport']) || !empty($this->_aVars['aAddition']['movies']) || !empty($this->_aVars['aAddition']['interests']) || !empty($this->_aVars['aAddition']['music']))
        {
            ...
            {
                $sHtml .= '<div class="info "><div class="info_left">'.Phpfox::getPhrase("resume.websites").':</div><div class="info_right"><p></p>';
            ...
            {
                $sHtml .= '<div class="info "><div class="info_left">'.Phpfox::getPhrase("resume.sport").': </div><div class="info_right">'.$this->_aVars['aAddition']['sport'].'</div></div>';
            }
            if (!empty($this->_aVars['aAddition']['movies']))
            {
                $sHtml .= '<div class="info "><div class="info_left">'.Phpfox::getPhrase("resume.movies").': </div><div class="info_right">'.$this->_aVars['aAddition']['movies'].'</div></div>';
            }
            if (!empty($this->_aVars['aAddition']['interests']))
            {
                $sHtml .= '<div class="info "><div class="info_left">'.Phpfox::getPhrase("resume.interests").':</div><div class="info_right">'.$this->_aVars['aAddition']['interests'].'</div></div>';
            }
            if (!empty($this->_aVars['aAddition']['music']))
            {
                $sHtml .= '<div class="info "><div class="info_left">'.Phpfox::getPhrase("resume.music").':</div><div class="info_right">'.$this->_aVars['aAddition']['music'].'</div></div>';
            }
            $sHtml .= '</div>';
        }
        $sHtml .= '</div>';
