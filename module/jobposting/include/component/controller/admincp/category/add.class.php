...
class Jobposting_Component_Controller_Admincp_Category_Add extends Phpfox_Component
{
	...
	public function process()
	{
		...
		$this->template()->setTitle(($bIsEdit ? Phpfox::getPhrase('jobposting.edit_an_industry') : Phpfox::getPhrase('jobposting.add_new_industry')))
			->setBreadcrumb(($bIsEdit ? Phpfox::getPhrase('jobposting.edit_an_industry') : Phpfox::getPhrase('jobposting.add_new_industry')), $this->url()->makeUrl('admincp.jobposting.category.add'))
			->assign(array(
