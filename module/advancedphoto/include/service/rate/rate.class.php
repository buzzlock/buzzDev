 ...
 */
class Advancedphoto_Service_Rate_Rate extends Phpfox_Service 
{
	/**
	 * Class constructor
	 */	
	...
	{		
		...
		$aPhoto['destination'] = Phpfox::getService('advancedphoto')->getPhotoUrl($aPhoto);
	...
	public function __call($sMethod, $aArguments)
	{
		 ...
		 */
		if ($sPlugin = Phpfox_Plugin::get('advancedphoto.service_rate__call'))
		{
			return eval($sPlugin);
		}
