 ...
 */
class Advancedphoto_Component_Block_Album extends Phpfox_Component
{
	/**
	...
	public function process()
	{
		...
		$aValidation = array(
			'name' => Phpfox::getPhrase('advancedphoto.provide_a_name_for_your_album'),
			'privacy' => Phpfox::getPhrase('advancedphoto.select_a_privacy_setting_for_your_album')
		);				
	...
	{
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_block_album_clean')) ? eval($sPlugin) : false);
	}
}
