 ...
 */
class Advancedphoto_Component_Block_Menu extends Phpfox_Component
{
	/**
	...
	{
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_block_menu_clean')) ? eval($sPlugin) : false);
