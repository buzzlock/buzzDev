 ...
 */
class Advancedphoto_Component_Block_Category extends Phpfox_Component
{
    /**
    ...
    public function process()
    {
		if (!Phpfox::isAdminPanel())
		{
			...
			$aCategories = Phpfox::getService('advancedphoto.category')->getForBrowse($sCurrentCategory, $this->getParam('sPhotoCategorySubSystem', null));
		    ...
		    $this->template()->assign(array(
					...
					'sHeader' =>  ($this->getParam('hasSubCategories') ? Phpfox::getPhrase('advancedphoto.subcategories') : Phpfox::getPhrase('advancedphoto.categories')),
		    	)
		    );
	    ...
	    $sCategories = Phpfox::getService('advancedphoto.category')->get($this->getParam('anchor', true));	    
	    ...
	    $this->template()->assign(array(
			    'sHeader' => Phpfox::getPhrase('advancedphoto.categories'),
    ...
    {
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_block_category_clean')) ? eval($sPlugin) : false);
    }
}
