 ...
 */
class Advancedphoto_Component_Block_Drop_Down extends Phpfox_Component
{
	/**
	...
	{
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_block_drop_down_clean')) ? eval($sPlugin) : false);
	}
}
