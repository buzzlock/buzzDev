 ...
 */
class Advancedphoto_Component_Controller_Album_Badge extends Phpfox_Component
{
	/**
	...
	public function process()
	{
		...
		if ($this->request()->getInt('req3') == 'profile')
		{
			...
			$aAlbum = Phpfox::getService('advancedphoto.album')->getForView($this->request()->getInt('req4'));
		...
		$this->template()
				...
				->setHeader('cache', array(
					...
					'advancedphoto-badge.css' => 'module_advancedphoto',
