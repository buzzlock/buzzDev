 ...
 */
class Advancedphoto_Component_Controller_Download extends Phpfox_Component
{
	/**
	...
	public function process()
	{
		...
		Phpfox::getUserParam('advancedphoto.can_download_user_photos', true);
		...
		{
			return Phpfox_Error::display(Phpfox::getPhrase('advancedphoto.not_allowed_to_download_this_image'));
		}
		...
		Phpfox::getService('advancedphoto.process')->updateCounter($aPhoto['photo_id'], 'total_download');
	...
	{
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_controller_download_clean')) ? eval($sPlugin) : false);
	}
}
