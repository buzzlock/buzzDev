 ...
 */
class Advancedphoto_Component_Controller_Profile extends Phpfox_Component
{
	/**
	...
	public function process()
	{
		...
		else 
		{
			...
			Phpfox::getComponent('advancedphoto.index', array('bNoTemplate' => true), 'controller');
		}
	}
	...
	{
		(($sPlugin = Phpfox_Plugin::get('advancedphoto.component_controller_profile_clean')) ? eval($sPlugin) : false);
	}
}
