...
function plugin_completeProgress()
{
	...
	{
		alert(oTranslations['advancedphoto.none_of_your_files_were_uploaded_please_make_sure_you_upload_either_a_jpg_gif_or_png_file']);
...
function deleteNewPhoto(iId)
{
	...
	{		
		...
		$.ajaxCall('advancedphoto.deleteNewPhoto', 'id=' + iId);
...
function uploadComplete()
{
	if (typeof swfu != 'undefined')
	{
		...
		else
		{
			...
			window.parent.$.ajaxCall('advancedphoto.process', 'js_disable_ajax_restart=true&' + sPhotos + '&action='+$('#js_photo_action').val());
		}
	}
}