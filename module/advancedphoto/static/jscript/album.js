...
$Behavior.photoUserBrowser = function()
{
	...
	{			
		...
		$.ajaxCall('advancedphoto.browseAlbum', $Core.parseUrlString(window.location.hash));	
	}
	*/
	...
	{
		$('#js_updating_album').html($.ajaxProcess(oTranslations['advancedphoto.updating_album']));
		
		$(this).ajaxCall('advancedphoto.updateAlbum');
	...
	$('.js_photo_set_cover').click(function()
	{
		...
		$.ajaxCall('advancedphoto.setAlbumCover', $Core.getHashParam(this.href));
