...
//			 console.log(src);
//			 console.log('#ynadvphoto_hidden_featured_photo_a_' +  $('input[name$="' + src + '"]'));
//			 console.log($('#ynadvphoto_hidden_featured_photo_a_' +  $('input[name$="' + src + '"]').attr('rel')));
			$('#ynadvphoto_hidden_featured_photo_a_' +  $('input[name$="' + src + '"]').attr('rel')).trigger('click');
		 });

//		 var src = $(image.container).children('img').attr('src');
//		 console.log(src);
//		 $(image.container).addClass('ynadvphoto_thickbox ynadvphoto_holder_image');
//		 $(image.container).attr('rel', $('input[name$="' + src + '"]').attr('rel'));
