...
<div {if $bFullMode} id="photo_battle_full_mode"{/if}>
	...
	<div id="photo_battl_full_close">
		{if $bFullMode}
		<a href="{url link='advancedphoto.battle'}">{phrase var='advancedphoto.close_full_mode'}</a>
		{else}
		<a href="{url link='advancedphoto.battle' mode='full'}">{phrase var='advancedphoto.open_full_mode'}</a>
		{/if}
	</div>	
	<div class="photo_battle_holder">
		<div class="photo_battle_left">
			...
			<div class="extra_info">
				{phrase var='advancedphoto.added_by_full_name_br_on_time_stamp' full_name=$aPhotos.one|user time_stamp=$aPhotos.one.time_stamp|convert_time}
			</div>			
		</div>
		<div class="photo_battle_center">{phrase var='advancedphoto.vs'}</div>	
		<div class="photo_battle_right">
			...
			<div class="extra_info">
				{phrase var='advancedphoto.added_by_full_name_br_on_time_stamp' full_name=$aPhotos.two|user time_stamp=$aPhotos.two.time_stamp|convert_time}
			</div>		
		</div>
	</div>
</div>
