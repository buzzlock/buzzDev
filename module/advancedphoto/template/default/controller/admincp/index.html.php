...
<form method="post" action="{url link='admincp.photo'}" id="js_form" onsubmit="{$sGetJsForm}">
	...
	<div class="table_header" id="js_photo_table_header">
		{phrase var='advancedphoto.add_a_photo_category'}
	</div>
	<div class="table" id="js_photo_parent">
		<div class="table_left">
			{phrase var='advancedphoto.parent'}:
		</div>
		<div class="table_right">
			{module name='advancedphoto.drop-down' multiple=false}
		</div>			
	</div>
	<div class="table">
		<div class="table_left">
			{phrase var='advancedphoto.name'}:
		</div>
		<div class="table_right">
...
<br />
	<form method="post" action="{url link='admincp.photo'}">
		<div class="table_header">
			{phrase var='advancedphoto.categories'}
		</div>
		<div class="table">
			<div class="sortable">		
				{module name='advancedphoto.category' parent=false anchor=false}
			</div>
		</div>
		<div class="table_clear">
			<span id="js_update_order"></span><input type="submit" value="{phrase var='advancedphoto.update'}" class="button" />
		</div>
	</form>
</div>