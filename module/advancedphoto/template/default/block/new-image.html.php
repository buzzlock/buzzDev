...
<div class="row1 js_uploaded_image" id="js_photo_{$aNewImage.photo_id}">
	<div class="go_left">
		<div style="position:relative;">
			<a href="#" title="{phrase var='advancedphoto.delete_this_image'}" onclick="return deleteNewPhoto('{$aNewImage.photo_id}');">{img theme='misc/delete.gif' class='delete_hover' style='position:absolute;'}</a>
