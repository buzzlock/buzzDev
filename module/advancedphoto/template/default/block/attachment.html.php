...
<div class="extra_info">
	{phrase var='advancedphoto.note_when_selecting_a_photo_to_import'}	
</div>
{/if}
...
{else}
<div class="extra_info">
	{phrase var='advancedphoto.no_photos_to_select_from'}
</div>
{/if}