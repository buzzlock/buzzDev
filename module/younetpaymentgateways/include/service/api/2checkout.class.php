 ...
 */
class Younetpaymentgateways_Service_Api_2checkout implements Younetpaymentgateways_gatewayinterface
{
	/**
	...
	public function getForm()
	{
		...
		$aForm = array(
			...
			'param' => array(
				...
				'x_receipt_link_url' => Phpfox::getService('younetpaymentgateways')->url('2checkout'),
