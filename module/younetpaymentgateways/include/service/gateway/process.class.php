 ...
 */
class Younetpaymentgateways_Service_Gateway_Process extends Phpfox_Service 
{
	/**
	 * Class constructor
	 */	
	...
	{
		$this->database()->insert(Phpfox::getT('younetpaymentgateways_gateway_log'), array(
				'gateway_id' => $sGateway,
	...
	{		
		$aForm = array(
			'title' => array(
				'message' => Phpfox::getPhrase('younetpaymentgateways.provide_a_name'),
				'type' => 'string:required',
				'convert' => true
			),
			'description' => array(
				'message' => Phpfox::getPhrase('younetpaymentgateways.provide_a_description'),
				'type' => 'string',
				'convert' => true
			),
			'is_active' => array(
				'message' => Phpfox::getPhrase('younetpaymentgateways.select_if_the_gateway_is_active_or_not'),
				'type' => 'int:required'
			),
			'is_test' => array(
				'message' => Phpfox::getPhrase('younetpaymentgateways.select_if_the_gateway_is_in_test_mode'),
				'type' => 'int:required'
			),
			'setting' => array(				
				'type' => 'array'
	...
	public function __call($sMethod, $aArguments)
	{
		 ...
		 */
		if ($sPlugin = Phpfox_Plugin::get('younetpaymentgateways.service_gateway_process__call'))
		{
			return eval($sPlugin);
		}
