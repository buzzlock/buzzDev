...
<div id="mt_status_share">
	<form method="post" action="#" onsubmit="$(this).ajaxCall('mobiletemplate.feedshare', false, false, 'POST'); return false;">
		    ...
		    <table>
		        <tr>
		            ...
		            <td class="ym-center-head">
		                <p>{phrase var='feed.share'}</p>
		            </td>
		            <td class="ym-right-head">
		                <div class="ym-main-header-right" style="padding-top:0">
				        <input class="btn btn-head" type="submit" id="btnShareStatus" value="{phrase var='share.post'}">
		               </div>
		            </td>
		        </tr>
		    </table>
