...
<div class="forum_header_menu">
	<ul class="sub_menu_bar">	
			...
			<div class="link_menu dropContent">
				...
				{/if}
					<div class="div_menu">
						<input type="text" name="search[keyword]" value="" class="v_middle" placeholder="{phrase var='forum.search_this_forum'}" style="width:60%"/> <input name="search[submit]" type="submit" value="Go" class="button v_middle" />
					</div>
					<div class="div_menu">
