...
<div style="margin-left:680px; position:relative; width:300px; overflow:hidden;" id="right_content" class="js_content_parent">
	<div class="block" id="js_block_border_younetcore_newsrss">
		<div class="title js_sortable_header">YouNet News &amp; Updates</div>
		<div class="content">
			<iframe src="http://auth.younetco.com/phpfox/newsrss.html" width="300px" height="1000px" frameborder="0"></iframe>		
		</div>
	</div>
</div>
<div class="clear"></div>