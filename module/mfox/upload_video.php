<html>
		...
		<script type="text/javascript">
            ...
            function doSubmit(form) {
            	try{
                    ...
                    $.ajax({
                        url: 'api.php/video/uploadVideoFromWall',  //server script to process data
                        headers: {
                            "token": sToken
                        },
                        type: 'POST',
    ...
    <body>
        <div style="width: 1100px;text-overflow: scroll;"><table>
                <tr>
                    <td width="500">
                        <form method="post" action="http://dev3.younetco.com/phrase3/upload/module/mfox/api.php" id="gform" enctype="multipart/form-data">
                            <div>
                                <div>
                                    Token:
                                </div>
                                <div>
                                    <input class="text" maxlength="200" type="text" name="token" value="google" id="sToken"/>
                                </div>
                            </div>
                            <div>
                                <div>
