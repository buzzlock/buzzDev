...
<div id="js_field_holder">
	...
	<form method="post" action="{url link='admincp.resume.custom.add'}" id="js_custom_field" onsubmit="{$sCustomGetJsForm}">
		<div class="table_header">
			{phrase var='resume.field_details'}
		</div>
			
		<div class="table">
			<div class="table_left">
				{phrase var='resume.required'}:
			</div>
			<div class="table_right">
				<label><input type="radio" name="val[is_required]" value="1" class="v_middle checkbox" {value type='checkbox' id='is_required' default='1'}/>{phrase var='resume.yes'}</label>
				<label><input type="radio" name="val[is_required]" value="0" class="v_middle checkbox" {value type='checkbox' id='is_required' default='0' selected=true}/>{phrase var='resume.no'}</label>
			</div>
		</div>	
		...
		<div class="table_header">
			{phrase var='resume.field_name_amp_values'}
		</div>	
        ...
        <div class="table" id="tbl_option_holder">
            <div class="table_left">{phrase var='resume.values'}:</div>
            <div class="table_right"> 
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='resume.add'}" class="button" />			
		</div>
	</form>
</div>
