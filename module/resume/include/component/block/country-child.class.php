 ...
 */
class Resume_Component_Block_Country_Child extends Phpfox_Component
{
	/**
	...
	{		
		$sCountryChildValue = $this->getParam('authorized_country_child_value');
		...
		if ($sCountryChildId == null && $this->getParam('authorized_country_child_id') == null)
		{
		...
		$this->template()->assign(array(
				...
				'iCountryChildId' => (int) $this->getParam('authorized_country_child_id', $sCountryChildId),
