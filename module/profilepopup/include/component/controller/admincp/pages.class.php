...
class ProfilePopup_Component_Controller_Admincp_Pages extends Phpfox_Component
{
        ...
        public function process()
        {
                ...
                $this->template()->setTitle(Phpfox::getPhrase('profilepopup.pages_global_settings'))
                        ->setBreadcrumb(Phpfox::getPhrase('profilepopup.pages_global_settings'), $this->url()->makeUrl('admincp.profilepopup.pages'))
                        ->assign(array(
                                'aAllItems' => $aAllItems
                                )
                        )
