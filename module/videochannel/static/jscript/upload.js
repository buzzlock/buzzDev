$Behavior.loadVideoIframe = function(){
	$('#js_upload_frame_holder').html('<iframe id="js_upload_frame" name="js_upload_frame" style="width:90%; height:500px; display:none;"></iframe>');
...
function uploadCompleted(iFile, sObjectId)
{
    ...
    $.ajaxCall("videochannel.convert", "video_id="+iFile+"&fObjectId="+sObjectId, 'GET');
