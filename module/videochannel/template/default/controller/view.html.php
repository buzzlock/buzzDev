                ...
                <div class="video_favourite_display">
                    <ul>
                        <li id='yn_videochannel_favourite'>
                            <a href="#" onclick="if(confirm('{phrase var='videochannel.are_you_sure'}')) addToFavourite({$aVideo.video_id}, {if (!$bIsFavourite)} 'favourite' {else} 'unfavourite' {/if}); return false;">
                                {if (!$bIsFavourite)} 
