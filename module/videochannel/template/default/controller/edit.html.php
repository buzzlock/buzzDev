...
<form method="post" action="{url link='videochannel.edit'}" onsubmit="return startProcess(true, false);" enctype="multipart/form-data">
	...
	<div id="js_video_block_detail" class="js_video_block page_section_menu_holder">
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='videochannel.save'}" class="button" />
		</div>		
	</div>
		...
		<div id="js_video_block_photo_holder">
			<div class="table">
				<div class="table_left">
					{phrase var='videochannel.video_photo'}:
				</div>
				<div class="table_right">
					...
					<div id="js_video_current_image">
						...
						<div class="extra_info">
							{phrase var='videochannel.click_to_delete_this_image' on_delete_image=$sOnClickDeleteImage}
						</div>
					...
					<div id="js_video_upload_image"{if !empty($aForms.image_path)} style="display:none;"{/if}>
						...
						<div class="extra_info">
							{phrase var='videochannel.you_can_upload_a_jpg_gif_or_png_file'}
							{if $iMaxFileSize !== null}
							{phrase var='videochannel.the_file_size_limit_is' iMaxFileSize_filesize=$iMaxFileSize_filesize}							
							{/if}						
						</div>
					</div>
				</div>
