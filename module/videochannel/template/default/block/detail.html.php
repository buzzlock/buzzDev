...
<div class="video_info_box">
	<div class="video_info_box_content">
		...
		<div class="video_info_box_text">
			{$aVideo.text|parse|shorten:'100':'videochannel.view_more':true}
		</div>
	...
	<a href="#" class="video_info_toggle">
		<span class="js_info_toggle_show_more">{phrase var='videochannel.show_more'} {img theme='layout/video_show_more.png'}</span>
		<span class="js_info_toggle_show_less">{phrase var='videochannel.show_less'} {img theme='layout/video_show_less.png'}</span>
	</a>	
</div>