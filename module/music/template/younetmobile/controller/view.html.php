<link href="{$core_url_module}mobiletemplate/static/css/default/default/mediaelementplayer.min.css" rel="stylesheet" type="text/css">
<script src="{$core_url_module}mobiletemplate/static/jscript/player/mediaelement-and-player.min.js" type="text/javascript"></script>
    ...
    <!-- Music player -->
    <div class="ym-music-player">
        <audio id="ymplayer" src="{$aSong.song_path}" type="audio/mp3" controls="controls" autoplay="true">        
        </audio>  
    </div>
      
{literal}
<script>
$Behavior.ymPlayer = function(){
    $('audio#ymplayer').mediaelementplayer({
        'audioWidth': '100%'
    });
}
