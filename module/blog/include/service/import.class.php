...
class Blog_Service_Import extends Phpfox_Service
{
	...
	public function install(){
		...
		array('admin_menu_uninstall_blog_importer_v3_02', 'Uninstall Blog Importer v3.02p3'),
		array('admin_menu_install_blog_importer_v3_02', 'Install Blog Importer v3.03p2')
		);
		...
		unset($aMenu['blog.admin_menu_install_blog_importer_v3_02']);
		$aMenu['blog.admin_menu_uninstall_blog_importer_v3_02'] = array('url' => array('blog','installer', 'uninstall'));
	...
	public function uninstall(){
		...
		$deleteSql = "DELETE FROM `".phpfox::getT('menu')."` WHERE (`var_name` LIKE 'menu_blog_import_blog%') OR (`var_name` LIKE '%menu_blog_export_blog%')";
		...
		array('username_does_not_exist', 'Username does not exist'),
		array('please_choose_a_file', 'Please choose a file'),
		array('please_enter_a_username', 'Plse enter a username'),
		...
		->execute('getField');
		$aMenu = unserialize($sMenu);
		unset($aMenu['blog.admin_menu_uninstall_blog_importer_v3_02']);

		$aMenu['blog.admin_menu_install_blog_importer_v3_02'] = array('url' => array('blog','installer', 'install'));
