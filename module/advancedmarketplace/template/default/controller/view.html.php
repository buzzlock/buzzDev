    ...
    <div class="row_title_image_header">
        ...
        <a href="{$aListing.url}">
            {if $aListing.image_path != NULL}
                {img title=$aListing.title path='core.url_pic' file='advancedmarketplace/'.$aListing.image_path suffix='_120' server_id=$aListing.server_id max_width='120' max_height='120'}
            {else}
