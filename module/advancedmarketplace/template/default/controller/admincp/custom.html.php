...
<form method="post" action="{url link='admincp.advancedmarketplace.custom.id_'.$iCatId}">
		<div class="sortable">
			<ul>
...
<div class="extra_info">
	...
	<ul class="action">
		<li><a href="{url link='admincp.advancedmarketplace.addcustomfield'}">{phrase var='custom.add_a_new_custom_field'}</a></li>
	</ul>
</div>
{/if}