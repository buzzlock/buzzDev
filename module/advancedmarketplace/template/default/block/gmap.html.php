...
<div style="padding-bottom: 2px;">
	<input id="location" type="text" style="width:220px;" value="{phrase var="advancedmarketplace.location"}..." onfocus="if(this.value=='{phrase var="advancedmarketplace.location"}...'){l}this.value=''{r}" onblur="if($.trim(this.value)==''){l}this.value='{phrase var="advancedmarketplace.location"}...'{r}" />
	<input id="city" type="text" style="width:200px;" value="{phrase var="advancedmarketplace.city"}..." onfocus="if(this.value=='{phrase var="advancedmarketplace.city"}...'){l}this.value=''{r}" onblur="if($.trim(this.value)==''){l}this.value='{phrase var="advancedmarketplace.city"}...'{r}" />
	<input id="radius" type="text" style="width:152px;" value="{phrase var="advancedmarketplace.radius"}..." onfocus="if(this.value=='{phrase var="advancedmarketplace.radius"}...'){l}this.value=''{r}" onblur="if($.trim(this.value)==''){l}this.value='{phrase var="advancedmarketplace.radius"}...'{r}" />
	<select id="distance">
