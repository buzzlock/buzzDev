...
<input type="button" id="today-listing-btnr" class="button" value="{phrase var="advancedmarketplace.save_changes"}" />
<script language="javascript" type="text/javascript">
	...
	$('#todaypicker{/literal}{$iId}{literal}').datepicker({
	...
	$("#today-listing-btnr").click(function(evt){
		evt.preventDefault();

		submit_todaylisting_form.ajaxCall("advancedmarketplace.advMarketTodayListing");
		tb_remove();
