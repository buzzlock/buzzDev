...
<div class="viewed_listing">
	{foreach from=$aRecentViewListing key=iKey item=aListing}
    ...
    <div class="clear"></div>
    {/foreach}
    {if $bIsViewMore}<div class="view_more_link"><a href="{url link='advancedmarketplace.search.sort_recent-viewed'}"  title="{phrase var='advancedmarketplace.view_more'}">{phrase var='advancedmarketplace.view_more'}</a></div>{/if}
</div>
{/if}