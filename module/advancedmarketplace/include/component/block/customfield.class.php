...
class AdvancedMarketplace_Component_Block_CustomField extends Phpfox_Component
{
	public function process()
	{
		...
		else 
		{
			...
			if(!isset($aCat))
			{
				...
				$aTotalGroups = phpfox::getService('advancedmarketplace.custom.group')->getFieldsByCatId($aCatId['category_id'], $iListingId);
			}
			else
			{
				$aCat = array();
