    ...
    {/if}
        ...
        <div class="activity_feed_form_holder">        
            ...
            <div class="global_attachment_holder_section" id="global_attachment_status" style="display:block;">
                ...
                <textarea id="eventFeedTextarea" cols="60" rows="8" name="val[user_status]">{if isset($aFeedCallback.module) || defined('PHPFOX_IS_USER_PROFILE')}{phrase var='feed.write_something'}{else}{phrase var='feed.what_s_on_your_mind'}{/if}</textarea>
            </div>
